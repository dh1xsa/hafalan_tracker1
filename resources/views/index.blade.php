...
<html lang="en">
  ...
  <head>
    ...
    <title>Hafalan Tracker - Kelompok 1</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-8">
          <ul class="info">
            <li><i class="fa fa-envelope"></i> mathaammar09@gmail.com</li>
            <li><i class="fa fa-map"></i> Depok kota kecil punya cerita, CC Cilodong Crazy</li>
          </ul>
        </div>
