...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            ...
            {{-- Looping setiap kelas yang dimiliki guru --}}
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full table-auto border border-gray-300">
                            ...
                            <tbody>
                                    ...
                                    <tr class="border-t hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 border">
                                            <a href="{{ route('student-detail.pdf', $data->id) }}"
                                                class="text-green-600 hover:underline font-medium" target="_blank">Ekspor
                                                PDF</a>
                                        </td>
                                        <td class="px-4 py-3 border">
                                            <button
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center py-4 text-gray-500">Belum ada murid di kelas
                                            ini.</td>
                                    </tr>
                                @endforelse
                            </tbody>
    ...
    {{-- Modal Input Hafalan --}}
    <div id="hafalanModal" class="fixed inset-0 bg-black bg-opacity-40 hidden z-50 flex justify-center items-center">
        <div class="bg-white w-full max-w-xl rounded-lg shadow-lg p-6 relative">
            ...
            <form action="{{ route('user-store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    <label for="score" class="block font-medium text-gray-700 mb-1">Nilai</label>
                ...
                .then(data => {
                    ...
                    if (data.length) {
                        ...
                        document.querySelectorAll('.openModalBtn').forEach(button => {
                            button.addEventListener('click', () => {
                                document.getElementById('studentId').value = button.dataset.id;
                                document.getElementById('studentName').value = button.dataset
                                    .name;
                                modal.classList.remove('hidden');
                                modal.classList.add('flex');
                            });
