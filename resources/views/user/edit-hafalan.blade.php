        ...
        <form action="{{ route('hafalan-update', $hafalan->id) }}" method="POST" class="space-y-4">
            ...
            <div>
                <div>
                    ...
                    <select name="surah" id="surah" class="w-full border rounded px-3 py-2" required>
                        <option value="" disabled {{ old('surah', $surahNumber ?? '') == '' ? 'selected' : '' }}>Pilih
                            surah</option>
            ...
            <div>
                ...
                <select name="status" id="status" required class="w-full rounded px-3 py-2 border">
                    ...
                    <option value="perlu diulang" {{ $hafalan->status == 'perlu diulang' ? 'selected' : '' }}>perlu diulang
                    </option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="date" name="date" value="{{ $hafalan->date }}" class="w-full border rounded px-3 py-2"
                    required>
            </div>
