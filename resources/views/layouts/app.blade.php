...
<body class="bg-gray-100 text-gray-800">
  ...
  <nav class="bg-white shadow px-4 py-4 flex justify-between items-center md:hidden relative">
    ...
    <div id="mobileMenu"
         ...
         style="max-height: 0;">
      <div class="p-4">
        <button onclick="openLogoutModal()" class="w-full px-4 py-2 text-white bg-red-500 hover:bg-red-600 rounded">
          Logout
        </button>
      </div>
    </div>
  ...
  <div id="logoutModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-lg p-6 shadow-lg max-w-sm w-full">
      ...
      <div class="flex justify-end space-x-2">
        <button onclick="closeLogoutModal()" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">Batal</button>
